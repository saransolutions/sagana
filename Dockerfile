...
RUN chmod +x xampp-linux-installer.run && \
  ...
  # Create a /sagana folder and a symbolic link to it in /opt/lampp/htdocs. It'll be accessible via http://localhost:[port]/sagana/
  # This is convenient because it doesn't interfere with xampp, phpmyadmin or other tools in /opt/lampp/htdocs
  mkdir /sagana && \
  ln -s /sagana /opt/lampp/htdocs && \
  # SSH server
...
VOLUME [ "/var/log/mysql/", "/var/log/apache2/", "/sagana", "/opt/lampp/apache2/conf.d/" ]
